...
\begin{figure}
%  a) \psfig{file=figures/phonetics.eps,width=0.4\linewidth}
%  b) \psfig{file=figures/letter.eps,width=0.4\linewidth}
%
%  c) \psfig{file=figures/bouma.eps,width=0.4\linewidth}
%
